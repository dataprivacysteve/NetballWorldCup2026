...
| 2. Accreditation and badge printing | **80%** | Complete 13-person roster passes real rules; atomic issuance and revoke/reissue pass; zero identity bytes retained. | Human UI sign-off; approve field/access-zone contract; implement and print-test the LOC's new non-QR template last. |
